...
- (void)updataTags:(NSArray *)tags allArray:(NSArray <TBDescriDicData *>*)array;
{
    ...
    _tagsView.originalData = self.labelIDArray;
...
- (void)changeButtonStyle;
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        else if (self.labelArray.count>0)
        {
            ...
            _tagsView.tags = [self.labelArray objectsAtIndexes:[NSIndexSet indexSetWithIndexesInRange:NSMakeRange(0, self.maxRow-1)]];
