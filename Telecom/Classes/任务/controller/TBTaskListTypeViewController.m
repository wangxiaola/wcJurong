...
{
    if ([data.code isEqualToString:@"service"])
    {
        TBServicePlaceViewController *businessVc = [[TBServicePlaceViewController alloc] init];
        businessVc.merchantsID = data.ID;
        businessVc.servicePlaceType = TBServicePlaceTypeEditor;
        [self.navigationController pushViewController:businessVc animated:YES];
    }
    else
    {
        __block NSInteger typeID;
        
        [self.typeArray enumerateObjectsUsingBlock:^(NSDictionary * obj, NSUInteger idx, BOOL * _Nonnull stop) {
