...
static NSString*const  reuseIdentifier_note = @"cell_note";
...
- (void)locationDidEndUpdatingLocation:(Location *)location;
{
    ...
    if (address.length == 0)
    {
        [self updataLocationAddress:location.POIName lat:location.latitude lon:location.longitude];
    }
...
- (void)updataMaking;
{
    ...
    self.makingList.serviceMsg = message;
